...
export default function LanguageSwitcher(){
 ...
 return <div className="wr-language" title={t('language','Language / Langue')} data-no-translate>
  ...
  <style jsx>{`.wr-language{position:fixed;left:50%;top:12px;transform:translateX(-50%);z-index:10050}.wr-language select{max-width:155px;border:1px solid #d7e0eb;border-radius:10px;background:#fff;color:#172033;padding:8px 9px;font-weight:700;box-shadow:0 3px 14px #00000018;cursor:pointer}@media(max-width:700px){.wr-language{top:8px}.wr-language select{max-width:118px;padding:7px 5px;font-size:12px}}`}</style>
 </div>
}
