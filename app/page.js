...
export default function Home() {
  ...
  return <main className="wr-landing">
    ...
    </section><div style={{display:'grid',gap:'12px',width:'min(420px,calc(100vw - 32px))'}}><video controls playsInline preload="metadata" src="/tutorial-80.mp4" style={{width:'100%',borderRadius:'18px',background:'#000',boxShadow:'0 10px 26px rgba(76,34,0,.28)'}} /></div></div>
  </main>
}
