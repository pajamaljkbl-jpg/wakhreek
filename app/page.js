...
export default function Home() {
  ...
  return <main className="wr-landing">
    ...
    </section><video controls playsInline preload="metadata" src="/tutorial-77.mp4" style={{width:'min(420px,calc(100vw - 32px))',borderRadius:'18px',background:'#000',boxShadow:'0 10px 26px rgba(76,34,0,.28)'}} /></div>
  </main>
}
