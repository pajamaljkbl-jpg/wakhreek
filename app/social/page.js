  ...
  return <AppShell>
    <main className="socialClean">
      ...
      <style jsx>{`
        ...
        .socialCleanLayout{display:grid;grid-template-columns:200px minmax(0,720px);justify-content:center;gap:16px;align-items:start}
        .socialCleanLeft{position:sticky;top:96px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;padding:12px}
        ...
        @media(max-width:1180px){.socialCleanLayout{grid-template-columns:180px minmax(0,1fr)}}@media(max-width:900px){.socialCleanLayout{grid-template-columns:1fr}.socialCleanLeft{position:static}}
