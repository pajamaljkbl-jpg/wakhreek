...
export default function SocialPage(){
 ...
 async function load(currentUser=user){
  ...
  if(ids.length){
   ...
   if(currentUser){const {data:fw}=await supabase.from('social_follows').select('following_id').eq('follower_id',currentUser.id);setFollows(fw||[])}
