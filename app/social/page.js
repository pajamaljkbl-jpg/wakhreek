  ...
  return <AppShell>
    <main className="socialClean">
      ...
      <style jsx>{`
        ...
        @media(max-width:1180px){.socialCleanLayout{grid-template-columns:180px minmax(0,1fr) 260px}}@media(max-width:900px){.socialCleanLayout{grid-template-columns:1fr}.socialCleanLeft{position:static}.socialCleanRight{display:none}}
