...
export default function SocialPage(){
 ...
 return <AppShell><main className="social">
  <section className="socialBrandBar"><div className="socialBrandTitle"><img src="/wakhreek-logo.png" alt="WakhReek" /><strong>Social</strong></div><div className="socialBrandSearch">🔎 <span>{t('socialSearchPeople','Search people…')}</span></div></section>
