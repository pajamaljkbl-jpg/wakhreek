  ...
  return <AppShell>
    <main className="socialClean">
      ...
      <style jsx>{`
        ...
        .socialCleanLayout{display:grid;grid-template-columns:200px minmax(0,720px) 360px;justify-content:center;gap:16px;align-items:start}
        .socialCleanLeft{position:sticky;top:96px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;padding:12px}.socialCleanRight{position:sticky;top:96px}
        ...
        .socialCleanRight h2{margin:0 0 14px;font-size:24px;color:#172033}.socialMarketShops{display:grid;gap:12px}.socialMarketShops article{background:transparent;border:0;border-radius:0;padding:12px 0;display:flex;gap:12px;cursor:pointer;transition:.15s;border-bottom:1px solid #edf1f5}.socialMarketShops article:last-child{border-bottom:0}.socialMarketShops article:hover{background:#f7fbff}.socialMarketLogo{width:58px;height:58px;flex:0 0 58px;border-radius:50%;background:#eff5ea;display:grid;place-items:center;font-size:30px;overflow:hidden}.socialMarketLogo img{width:100%;height:100%;object-fit:cover}.socialMarketShops article>div:last-child{min-width:0}.socialMarketShops h3{margin:2px 0;font-size:18px;color:#172033}.socialMarketShops small,.socialMarketShops p{color:#667085;font-size:11px}.socialMarketShops p{margin:9px 0}.socialMarketShops button{border:0;border-radius:8px;padding:7px 9px;background:#0875e8;color:white;font-weight:800;cursor:pointer;font-size:11px}
        ...
        @media(max-width:1180px){.socialCleanLayout{grid-template-columns:180px minmax(0,1fr) 300px}}@media(max-width:900px){.socialCleanLayout{grid-template-columns:1fr}.socialCleanLeft{position:static}.socialCleanRight{position:static}}
