...
async function getRtcConfig() {
  try {
    ...
    if (!session?.access_token) return FALLBACK_RTC_CONFIG
    ...
    if (!Array.isArray(data?.iceServers) || !data.iceServers.length) return FALLBACK_RTC_CONFIG
    return { iceServers: data.iceServers }
  } catch (error) {
    console.warn('Metered TURN unavailable, using STUN fallback', error)
